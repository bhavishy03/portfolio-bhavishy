...
import { cn } from "@/lib/utils" // Fix cn import path for this project
...
const Globe: React.FC<GlobeProps> = ({
  ...
  useEffect(() => {
    ...
    const resolvedGlowColor: [number, number, number] =
      typeof glowColor === "string" ? hexToRgbNormalized(glowColor) : glowColor || [0.2745, 0.5765, 0.898] // Default if not provided or invalid hex
